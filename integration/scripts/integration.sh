...
run_integration_tests() {
    ...
    bash -c "${DC} -f docker-compose.spdk.yml exec -T spdk-target /root/spdk/build/examples/identify -r 'traddr:10.127.127.4 trtype:TCP adrfam:IPv4 trsvcid:4420'"
    ...
    bash -c "${DC} -f docker-compose.spdk.yml exec -T spdk-target /root/spdk/build/examples/perf     -r 'traddr:10.127.127.4 trtype:TCP adrfam:IPv4 trsvcid:4420' -c 0x1 -q 1 -o 4096 -w randread -t 10"
    bash -c "${DC} -f docker-compose.xpu.yml  exec -T xpu-spdk /root/spdk/build/examples/perf        -r 'traddr:10.127.127.4 trtype:TCP adrfam:IPv4 trsvcid:4420' -c 0x1 -q 1 -o 4096 -w randread -t 10"
}
