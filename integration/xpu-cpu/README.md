...
```text
$ ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -p 2207 xpu@127.0.0.1
Warning: Permanently added '[127.0.0.1]:2207' (ECDSA) to the list of known hosts.
xpu@127.0.0.1's password:
